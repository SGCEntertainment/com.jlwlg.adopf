...
public class Engine : MonoBehaviour
{
    ...
    {
		public string giuas;
        public string gaikwjdf;
        public string ghaaio2o;
        public string jkiswsd;
        public string zaef4f;
        public string fg32ind;
        public string h3jhkaske;
		...
		{
			return !string.Join(giuas, gaikwjdf, ghaaio2o, jkiswsd, zaef4f, fg32ind, h3jhkaske).Contains(stopword);
		}
    }
}
